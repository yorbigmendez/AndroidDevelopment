...
public class FragmentListado extends Fragment {
	...
	public static Correo[] datos =
	    	new Correo[]{
	    		new Correo("Persona 1", "Asunto del correo 1", "Texto del correo 1",1),
	    		new Correo("Persona 2", "Asunto del correo 2", "Texto del correo 2",2),
	    		new Correo("Persona 3", "Asunto del correo 3", "Texto del correo 3",1),
	    		new Correo("Persona 4", "Asunto del correo 4", "Texto del correo 4",2),
	    		new Correo("Persona 5", "Asunto del correo 5", "Texto del correo 5",1)};
			...
			public void onItemClick(AdapterView<?> list, View view, int pos, long id) {
				if (listener!=null) {
					listener.onCorreoSeleccionado(
							DetalleActivity.CORREO_SELECCIONADO = pos);
				}
			}
		});
	}
